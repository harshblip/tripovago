        ...
        <>
            <div className="p-6 page">
                ...
                <div className="mt-4">
                    ...
                    <p className={`text-[#0FA4C2] ${kavoon.className} -mt-48 ml-36 text-4xl`}> Marine </p>
                </div>
                <div className={`${lexend.className} w-full max-w-screen-xl mx-auto p-4 mt-44`}>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-10 ml-[15rem]">
                ...
                <div className={`flex ${lexend.className} mt-20`}>
                ...
                <div className={`${lexend.className} mt-10 flex flex-col`}>
                    <p className="font-medium text-4xl ml-8 text-[#0FA4C2]"> Why choose us ? </p>
                    <div className="flex space-x-20 justify-center mt-8">
                        {
                            data.map((x, i) => {
                                return (
                                    x.type === "marine" ? <div className="bg-[#198797] shadow-lg rounded-lg flex flex-col justify-center items-center text-white space-y-8 h-[14rem] w-[12rem]">
                ...
                <div className="mt-24 flex justify-between">
                    <div className={`ml-12 flex flex-col space-y-2 ${lexend.className}`}>
                        <p className="text-xl text-[#91C2CA]"> to know more </p>
                        <p className="text-4xl font-medium text-[#0EA4C2]"> Contact Us </p>
                    </div>
                    <div className={`${lexend.className} flex flex-col mr-12`}>
                        <div className="flex space-x-4">
                            <img src='./images/Phone.png' className="w-6" />
                            <p className="text-md font-normal text-[#327C88]"> +91 8860922191 </p>
                            <p className="text-md font-normal text-[#327C88]"> +91 7982769510 </p>
                        </div>
            ...
            <img src='./images/vector.png' className="w-full h-44" />
        </>
    )
}