    ...
    return (
        <div className="flex justify-center mt-[2rem]">
            <Carousel
                ...
                className="sm:w-[90rem] w-[24rem] mt-[0rem] mr-4 sm:mr-0"
                                    ...
                                    <div key={i}>
                                        <CarouselItem className={`${lexend.className}`}>
                                            <div className="flex items-center justify-center">
                                                <Card className={`sm:w-[90rem] w-[24rem] h-[24rem] sm:h-[28rem] bg-no-repeat bg-cover bg-center ${x.id === 2 ? `bg-no-repeat bg-[length:100%]` : ``} `} style={{ backgroundImage: `url(${x.bg})` }}>
                                                    {
